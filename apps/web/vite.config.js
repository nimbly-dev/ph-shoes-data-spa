  ...
  return {
    ...
    resolve: {
      alias: {
        ...
        '@widgets/alerts-list': path.resolve(__dirname, '../..', 'packages/widgets/alerts-list/src'),
        '@widgets/alerts-detail': path.resolve(__dirname, '../..', 'packages/widgets/alerts-detail/src'),

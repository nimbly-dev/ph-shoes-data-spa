...
export function AlertModal({ open, onClose, product, existingAlert, onSave, onDelete }: Props) {
  ...
  const handleSave = async () => {
    ...
    const payload: AlertCreateRequest | AlertUpdateRequest = {
      ...
      productImageUrl: form.productImageUrl ?? (product as any).productImageUrl ?? product.image,
